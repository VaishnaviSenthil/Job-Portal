import { USER_SIGNIN_REQUEST ,USER_SIGNIN_SUCCESS,USER_SIGNIN_FAIL,USER_SIGNIN_RESET, USER_LOGOUT_REQUEST, USER_LOGOUT_SUCCESS, USER_LOGOUT_FAIL, USER_LOGOUT_RESET, USER_LOAD_REQUEST, USER_LOAD_SUCCESS, USER_LOAD_FAIL, USER_LOAD_RESET, USER_APPLY_REQUEST, USER_APPLY_SUCCESS, USER_APPLY_FAIL, USER_APPLY_RESET, ALL_USER_LOAD_REQUEST, ALL_USER_LOAD_SUCCESS, ALL_USER_LOAD_FAIL, ALL_USER_LOAD_RESET} from "../constants/userConstants"
...
// Apply for job
export const userApplyJob = (state = {}, action) => {
    switch (action.type) {
