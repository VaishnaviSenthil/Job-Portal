...
import logoDashboard from '../../images/hibizLogo.jpg';
...
const SidebarAdm = () => {
    ...
    return (
        <>
            <Sidebar collapsed={isMobileView} backgroundColor="#003366" style={{ borderRightStyle: "none" }}>
                <Box sx={{ display: "flex", justifyContent: "space-between", flexDirection: "column", height: "100%" }}>
                    <Box>
                        ...
                        <Typography sx={{ color: 'white', textAlign: 'center' }} variant='h5'>Job Portal</Typography>
                        <Menu
                            menuItemStyles={{
                                button: {
                                    [`&.${menuClasses.button}`]: {
                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/admin/status" />} icon={<PeopleIcon />}> Applied Users </MenuItem>
                                    ...
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/user/apply/jobs" />} icon={<CreateIcon />}> Apply Jobs </MenuItem>
                                        <MenuItem component={<Link to="/user/jobs" />} icon={<HistoryIcon />}> Applied Jobs </MenuItem>
                                        <MenuItem component={<Link to="/userProfile" />} icon={<AccountCircleIcon />}> Your Profile </MenuItem>
                                    </>
                            }
